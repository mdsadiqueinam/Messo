...
const val NOW_PLAYING_CHANNEL_ID = "com.sadique.messo.media.NOW_PLAYING"
 ...
 */
class MessoNotificationManager(
    ...
    private inner class DescriptionAdapter(private val controller: MediaControllerCompat) :
        ...
        override fun getCurrentLargeIcon(
            ...
            val iconBitmap = controller.metadata.description.iconBitmap

            return when {
                (iconUri != null && currentIconUri != iconUri) -> {
                ...
                (iconBitmap != null && iconBitmap != currentBitmap) -> {
                    currentBitmap = iconBitmap
                    currentBitmap
                }
                else -> currentBitmap
            }
