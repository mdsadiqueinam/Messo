...
import com.sadique.musicservice.media.extensions.asAlbumArtContentUri
    ...
    suspend fun saveRecentSong(description: MediaDescriptionCompat, position: Long) {
        ...
        withContext(Dispatchers.IO) {
            ...
            preferences.edit().apply {
                ...
                localIconUri?.let{ putString(RECENT_SONG_ICON_URI_KEY, it.toString()) }
...
private const val PREFERENCES_NAME = "messo"
