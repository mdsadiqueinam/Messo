...
interface MusicSource : Iterable<MediaMetadataCompat> {
    ...
    fun getCatalog(): MutableList<MediaMetadataCompat>
    ...
    fun search(extras: Bundle): List<MediaMetadataCompat>

    fun search(query: String): List<MediaMetadataCompat>
}
...
/**
 * Base class for music sources in Messo.
 */
abstract class AbstractMusicSource : MusicSource {
     ...
     */
    override fun search(extras: Bundle): List<MediaMetadataCompat> {
    ...
    /**
     * Handles searching a [MusicSource] from a query string
     */
    override fun search(query: String): List<MediaMetadataCompat> {
    ...
    override fun search(query: String, extras: Bundle): List<MediaMetadataCompat> {
        ...
        val focusSearchResult = search(extras)
